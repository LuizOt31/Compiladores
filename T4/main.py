    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            if error_listener.lexical_errors:
                f.write("\n".join(error_listener.lexical_errors) + "\n")
            ...
            if error_listener.lexical_errors:
                output_lines.extend(error_listener.lexical_errors)
            
            if error_listener.syntax_errors:
                output_lines.extend(error_listener.syntax_errors)
            
            if analyzer.errors:
                output_lines.extend(analyzer.errors)
