...
public class colorartLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "T__14", "VAR", "HEXCOLOR", 
			"INT", "WS", "COMMENT"
		};
	}
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		switch (ruleIndex) {
		case 16:
			HEXCOLOR_action((RuleContext)_localctx, actionIndex);
			break;
		}
	}
	private void HEXCOLOR_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 0:
			6
			break;
