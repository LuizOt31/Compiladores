// Generated from /home/lo/Documentos/Obsidian/UFSCar/7_semestre/Compiladores/Compiladores/T2/LA.g4 by ANTLR 4.13.1
...
public class LAParser extends Parser {
	...
	public static final int
		...
		T__45=46, T__46=47, T__47=48, OP_ARIT=49, OP_REL=50, OP_LOGICO=51, DELIM=52, 
		ABRE_PAR=53, FECHA_PAR=54, ABRE_COLCH=55, FECHA_COLCH=56, VIRGULA=57, 
		PONTO=58, PONTEIRO=59, ENDERECO=60, ATRIBUICAO=61, DOIS_PONTOS=62, IDENT=63, 
		CADEIA=64, NUM_INT=65, NUM_REAL=66, COMENTARIO=67, WS=68, COMENTARIO_NAO_FECHADO=69, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, "OP_ARIT", "OP_REL", "OP_LOGICO", "DELIM", "ABRE_PAR", "FECHA_PAR", 
			"ABRE_COLCH", "FECHA_COLCH", "VIRGULA", "PONTO", "PONTEIRO", "ENDERECO", 
			"ATRIBUICAO", "DOIS_PONTOS", "IDENT", "CADEIA", "NUM_INT", "NUM_REAL", 
	...
	public final DeclaracoesContext declaracoes() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 163928L) != 0)) {
				{
				{
				setState(106);
				decl_local_global();
	...
	public static class DimensaoContext extends ParserRuleContext {
		public List<TerminalNode> ABRE_COLCH() { return getTokens(LAParser.ABRE_COLCH); }
		public TerminalNode ABRE_COLCH(int i) {
			return getToken(LAParser.ABRE_COLCH, i);
		}
		...
		public List<TerminalNode> FECHA_COLCH() { return getTokens(LAParser.FECHA_COLCH); }
		public TerminalNode FECHA_COLCH(int i) {
			return getToken(LAParser.FECHA_COLCH, i);
		}
	...
	public final Valor_constanteContext valor_constante() throws RecognitionException {
		...
		try {
			...
			setState(176);
			_la = _input.LA(1);
			if ( !(((((_la - 11)) & ~0x3f) == 0 && ((1L << (_la - 11)) & 63050394783186947L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final Declaracao_globalContext declaracao_global() throws RecognitionException {
		...
		try {
			...
			case T__14:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -8646911238842875904L) != 0)) {
					{
					{
					setState(200);
					cmd();
	...
	public final Exp_relacionalContext exp_relacional() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 68169720922144L) != 0)) {
				{
				setState(506);
				op_relacional();
				setState(507);
